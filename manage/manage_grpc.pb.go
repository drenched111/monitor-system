...
type ManageServiceClient interface {
	GetThreshold(ctx context.Context, in *ManageReq, opts ...grpc.CallOption) (*ManageRspList, error)
}
...
func (c *manageServiceClient) GetThreshold(ctx context.Context, in *ManageReq, opts ...grpc.CallOption) (*ManageRspList, error) {
	out := new(ManageRspList)
	err := c.cc.Invoke(ctx, "/ManageService/GetThreshold", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ManageServiceServer interface {
	GetThreshold(context.Context, *ManageReq) (*ManageRspList, error)
...
func (UnimplementedManageServiceServer) GetThreshold(context.Context, *ManageReq) (*ManageRspList, error) {
...
func _ManageService_GetThreshold_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ManageReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ManageServiceServer).GetThreshold(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ManageService/GetThreshold",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ManageServiceServer).GetThreshold(ctx, req.(*ManageReq))
	}
...
var ManageService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "ManageService",
	HandlerType: (*ManageServiceServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "GetThreshold",
			Handler:    _ManageService_GetThreshold_Handler,
		},
	},
